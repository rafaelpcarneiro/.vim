...
syntax match headerParameters /^\\theoremstyle/                  containedin=ALL
...
syntax match myMaketitleToc   /\\\(maketitle\|tableofcontents\)/ containedin=ALL
...
hi myMaketitleToc      ctermfg=19  ctermbg=none  
